...
tidydata %>%
  ...
  coord_flip() +
  labs(x = NULL, y = NULL, 
       title = "Income sources by council area") +
  theme(legend.title = element_blank())
...
tidydata %>%
  ...
  coord_flip() +
  labs(x = NULL, y = NULL, 
       title = "Income sources by urban/rural class",
       subtitle = "Sample >= 50") +
  theme(legend.title = element_blank())
...
tidydata %>%
  ...
  coord_flip() +
  labs(x = NULL, y = NULL,
       title = "Age profile of council areas") +
  theme(legend.title = element_blank(),
        legend.position = "top") +
...
tidydata %>%
  ...
  coord_flip() +
  labs(x = NULL, y = NULL,
       title = "Age profile of urban/rural areas",
       subtitle = "Sample >= 50") +
  theme(legend.title = element_blank(),
        legend.position = "top",
