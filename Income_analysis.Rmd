...
This report assesses how closely income data collected in the Scottish Household Survey (SHS) matches that of the Household Below Average Incomes (HBAI), the "gold standard" for household income data in the UK. The purpose of this assessment is to understand whether SHS income data is accurate enough to allow household income and poverty analysis in Scotland where this is not possible using the HBAI or administrative data sources. Income and poverty analysis in Scotland is not possible with HBAI or admin data for certain subgroups of the population where the HBAI sample is too small, and where these subgroups are not identified in the administrative data. This is also the case for a wide range of contexts which are not covered or not covered in as much detail in the HBAI or admin data, such as travel patterns, social capital, satisfaction with services, house condition, digital inclusion and financial inclusion. 

It should be noted however that by undertaking this work, we are not proposing a wholesale shift in reporting income and poverty statistics from HBAI to SHS income data; the HBAI will remain the main source of national (Scotland-level) poverty and household income statistics, with SHS statistics providing supplementary income and poverty analysis as highlighted above.
...
1. Looking at the summary above and the analysis on which it is based, do you come to the same conclusions?

2. We propose to produce further analysis for your review where we compare SHS-based BHC poverty estimates (excluding pensioners) with HBAI poverty estimates. In addition, we will compare SHS-based child poverty estimates with the recently published admin data-based child poverty estimates (CiLiF). Do you have any views on this proposal?

## Introduction

This report assesses how closely income data collected in the Scottish Household Survey (SHS) matches that of the Household Below Average Incomes (HBAI), the "gold standard" for household income data in the UK. The purpose of this assessment is to understand whether SHS income data is accurate enough to allow household income and poverty analysis in Scotland where this is not possible using the HBAI or administrative data sources. That's the case for certain subgroups of the population where the HBAI sample is too small, and where these subgroups are not identified in the administrative data. That's also the case for a wide range of contexts which are not covered in the HBAI or admin data, or not in as much detail, such as travel patterns, social capital, satisfaction with services, house condition, digital inclusion and financial inclusion. 

Note though the HBAI will remain the main source of national (Scotland-level) poverty and household income statistics.
