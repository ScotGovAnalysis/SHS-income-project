...
We found that average earnings were slightly (but statistically significantly) higher in the SHS than in the HBAI, but that for lower household incomes, SHS earnings were _lower_ than HBAI earnings. Average earnings for the small number of households whose highest income householder is self-employed were much higher in the SHS compared to the HBAI, probably due to differences in survey methodology. 

Average benefit income was lower in the SHS compared to the HBAI, caused by underreporting and non-reporting of benefits. The impact of under- and non-reporting of the State Pension dwarved the impact of all other (also underreported) benefits and affects almost all pensioner households - those whose main income source is the State Pension. Underreporting of disability benefits affects households where these benefits are a major or the main income source, such as economically inactive households due to disability or longterm illness.
