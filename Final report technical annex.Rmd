...
# load workspace and packages in case doc gets knitted directly
...
This is the technical annex to the final report of the Scottish Household Survey (SHS) income project. The SHS income project assessed in detail how accurately the SHS measures household income. To this end, we compared SHS data to data from the Households Below Average Income (HBAI) dataset, the “gold standard” for estimating household income data in the UK.
...
This annex shows the detailed analysis done in charts and tables.

***

**Important note**

The information in this report can only be used for assessing the quality of the SHS income data and for no other purpose. In particular, HBAI-based statistical estimates for areas within Scotland, such as individual council areas, are generally not considered robust.
...
`r knitr::kable(tb44, align = "lrr")`

**Pensioners are excluded from the analysis that follows.**

Relative poverty rates (excluding pensioners):
`r knitr::kable(tb45, align = "lrr")`

Composition of groups in relative poverty (excluding pensioners):
`r knitr::kable(tb46, align = "lrr")`
...
`r knitr::kable(tb47, align = "rrr")`

#### by family type

Number of children in relative poverty:
`r knitr::kable(tb48, align = "lrr")`
